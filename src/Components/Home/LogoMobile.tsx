...
const LogoMobile = ({ boxRef, firstWordRef, secondWordRef, thirdWordRef }) => {
  const fill = theme.backgroundColor.white;
  return (
    <div>
      <svg
        version="1.1"
      ...
      >
        ...
        >
          <g>
            <rect fill={fill} x="46.172" y="55.5" width="14" height="386" />
          </g>
          <g>
            <rect fill={fill} x="60.167" y="41.5" width="430.005" height="14" />
          </g>
          <g>
            <rect
              fill={fill}
          ...
          <g>
            <rect fill={fill} x="490.172" y="55.5" width="14" height="386" />
          </g>
        </g>
      </svg>
    </div>
